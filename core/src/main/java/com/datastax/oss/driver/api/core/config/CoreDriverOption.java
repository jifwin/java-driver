...
public enum CoreDriverOption implements DriverOption {
  ...
  METRICS_NODE_CQL_MESSAGES_HIGHEST("metrics.node.cql_messages.highest_latency", false),
  METRICS_NODE_CQL_MESSAGES_DIGITS("metrics.node.cql_messages.significant_digits", false),
  METRICS_NODE_CQL_MESSAGES_INTERVAL("metrics.node.cql_messages.refresh_interval", false),
